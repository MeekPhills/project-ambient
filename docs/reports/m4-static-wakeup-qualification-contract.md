...
native evaluator, requires every output to bind source-producing revision
`b439193ed513811bec90ce2491ec30033aa2a4e4` exactly, byte-pins the schema, and
runs current/future synthetic cases
