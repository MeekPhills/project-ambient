...
**Parent baseline for this handoff:** `8cb32cfddb29fd37f5199074b1bb3c202cf6b189` on `main`, including merged PR #64.

**Working branch:** `feat/28-public-media-capability-probe` in `~/Developer/project-ambient`; the protected checkout is untouched. The historically specified #37 isolated worktree is not currently present or registered, so do not recreate or reconstruct it; its remaining product evidence is blocked pending an owner-directed safe workspace decision.
