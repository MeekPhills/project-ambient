  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <nav aria-label="Help links"><strong>Help</strong><a href="/status">Production status</a><a href="/support">Support</a><a href="/#faq">FAQ</a><a href="/support#diagnostics">Report an issue</a></nav>
      </div>
