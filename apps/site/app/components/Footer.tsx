  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <nav aria-label="Product links"><strong>Product</strong><a href="/#how-it-works">How it works</a><a href="/#power">Power behavior</a><a href="/#open-source">Open source</a><a href="/downloads/Project-Ambient-alpha.zip" download>Download</a></nav>
